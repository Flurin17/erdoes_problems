...
encoded filters. The values `14`, `15`, `21`, `22`, and `30` formerly appeared
in this list, but are now classified negative in `PROOF.md` after writing out
the source-row arithmetic eliminations:

```text
33, 35, 38, 39, 42, 46, 51, 55, 56, 57, 60, 62, 63, 66,
...
3. Use the `N=14`, `N=15`, `N=21`, `N=22`, and `N=30` proofs as templates for
