...
over `5867040` outside-cover shells. The first `100000` classified word groups
cover cumulative weight `1623240` and again show no mixed-status word group.
...
`EXPERIMENTS/results/n99_mixed6_word_quotient_050000_100000.json`.
