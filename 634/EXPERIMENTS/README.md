...
- `gamma_2alpha_word_quotient_census.py`: exact count-plus-representative
  ...
  realization of each selected word group; in the first `330000` `N=99`
  mixed-`6` word groups, all `4673580` outside-cover realizations match the
...
- `gamma_2alpha_word_exhaustive_summary.py`: verifier for disjoint exhaustive
  ...
  totals. The current summary for the first `330000` `N=99` mixed-`6` word
  groups is stored in
  `results/n99_mixed6_word_exhaustive_summary_000001_330000.json`.
