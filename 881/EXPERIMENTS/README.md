...
for low-count packets. Its lower-order hypergraph check verifies that the
transversal formulation in Corollary 3.4d.12 is equivalent, on finite
...
two-sum shrink used in Corollary 3.4d.18 and the singleton/parallel-copy
split with trapped self- and cross-shadows used in Corollary 3.4d.20.
...
large-mass width/displacement split in Lemma 16.118, as well as the finite
